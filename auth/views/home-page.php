  ...
  <header class="flex items-center justify-between px-4 md:px-8 py-4 shrink-0">
    <div class="flex items-center gap-3">
     <img src="/student-discipline-and-incident-reporting-system/public/assets/images/SD&IRS.png" alt="Logo" class="w-[7vw] ">
      <h1 class="text-[#0B3C5D] text-xl md:text-4xl">
...
<div
  ...
  <p class="text-[#0B3C5D] text-base md:text-2xl leading-relaxed text-center 
  ...
  <a href="login" 
     class="mt-6 px-10 py-3 rounded-2xl bg-white/30 backdrop-blur-md border border-white/30 
  ...
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <!-- Left: Copyright -->
    <p class="text-[#0B3C5D] text-center md:text-left text-sm md:text-base">
      © 2026 Student Discipline & Incident Reporting System. All rights reserved.
    </p>

    <!-- Right: Class info and names in two lines -->
    <div class="text-[#0B3C5D] text-center md:text-left text-sm md:text-base">
      <p>BSIT 3 BLOCK 2:</p>
