...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 flex flex-col gap-2 text-white overflow-y-auto">
        <a href="teacher-dashboard" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-all duration-300">
            <i class="fa-solid fa-gauge-high w-5"></i> Dashboard
        </a>
        <a href="reports-incident" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-all duration-300">
            <i class="fa-solid fa-triangle-exclamation w-5"></i>Reports Incident
        </a>
        <a href="my-advisories" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-all duration-300">
            <i class="fa-solid fa-scale-balanced w-5"></i> My Advisory
        </a>
